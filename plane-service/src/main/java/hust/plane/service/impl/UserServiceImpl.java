...
//        }
    ...
    @Override
    public int addUserWithInfo(Integer addUserId, String addUsername, String addUserPaw, String addUserRole, String addUserDescripte) {
        if (addUserId==null || StringUtils.isBlank(addUsername) || StringUtils.isBlank(addUserPaw) || StringUtils.isBlank(addUserRole) || StringUtils.isBlank(addUserDescripte)) {
